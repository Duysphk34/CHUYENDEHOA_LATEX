...
class LatexEnvironmentGenerator(QMainWindow):
    ...
    def on_output_changed(self):
        ...
        try:
            ...
            # Chỉ cập nhật nếu nội dung thay đổi và không trống
            if new_content and new_content != current_clipboard:
                clipboard.setText(new_content)
                # Không hiển thị thông báo để tránh gây phiền nhiễu
    ...
    def convert_list(self, conversion_type):
        ...
        try:
            ...
            if text:
                ...
                # Tắt signal tạm thời để tránh trigger khi set text
    ...
    def get_input_text(self, input_textbox):
        ...
        if not text:
            ...
            if text:
                # Tạm thời ngắt kết nối signal để tránh vòng lặp
