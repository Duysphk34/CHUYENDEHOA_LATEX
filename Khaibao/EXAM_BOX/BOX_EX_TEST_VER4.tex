...
\AtBeginEnvironment{ex}{
	...
	\renewcommand{\loigiai}[1]{\par\noindent%
		{\color{\maunhan}\reflectbox{\Large\WritingHand}\ {\fmmfamily\LARGE Lời giải.}} #1
		\ifthenelse{\value{numTrueSol}>0}{
			\hfill \textcolor{\maunnhan}{\sffamily \faKey~\circleTrue[\maunhan]{\Alph{numTrueSol}}}
		}{}
	}
} 
...
%\end{vdbox}
%\def\vdend{}
%\gdef\tieudehinh{}\par\noindent{\color{\maunhan}\reflectbox{\Large\WritingHand}{\color{\maunhan}\fmmfamily\LARGE Lời giải.}}\par%
...
\def\vdexend{}
\begin{center}
\gdef\tieudehinh{}{\color{\maunhan}\reflectbox{\Large\WritingHand}{\color{\maunhan}\fmmfamily\LARGE Lời giải.}}
\end{center}
\noindent\ignorespaces#1%#1
\ifthenelse{\value{numTrueSol}>0}{
